...
public class Sign_Up_gen extends Fragment {
    ...
    public static Sign_Up_gen newInstance(String param1, String param2) {
        Sign_Up_gen fragment = new Sign_Up_gen();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v= inflater.inflate(R.layout.fragment_sign__up_gen, container, false);
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            ...
                                            riversRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    shadow.setVisibility(View.GONE);
                                                    progressBar.setVisibility(View.GONE);
                                                    Intent intent = new Intent(getActivity(), genHome.class);
